...
const DEFAULT_TRACE_SAMPLE_RATE = 0.02;

const dsn = (process.env.SENTRY_DSN_STEWARD || process.env.SENTRY_DSN || '').trim();
const environment = process.env.SENTRY_ENVIRONMENT || process.env.NODE_ENV || 'development';
const release = process.env.SENTRY_RELEASE || undefined;
const tracesSampleRate = parseSampleRate(
  process.env.SENTRY_TRACES_SAMPLE_RATE_STEWARD || process.env.SENTRY_TRACES_SAMPLE_RATE,
