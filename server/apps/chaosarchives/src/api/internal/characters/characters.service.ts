...
export class CharactersService {
  ...
  async getCharacterProfile(
    ...
    return {
      ...
      haircolorShade1: character.haircolorShade1,
      haircolorShade2: character.haircolorShade2,
      eyecolorShade1: character.eyecolorShade1,
      eyecolorShade2: character.eyecolorShade2,
      skintoneShade1: character.skintoneShade1,
      skintoneShade2: character.skintoneShade2,
  ...
  async saveCharacter(characterDto: CharacterProfileDto, user: UserInfo): Promise<void> {
    const characterEntity = await this.connection.transaction(async em => {
        ...
        haircolorShade1: characterDto.haircolorShade1 || '',
        haircolorShade2: characterDto.haircolorShade2 || '',
        eyecolorShade1: characterDto.eyecolorShade1 || '',
        eyecolorShade2: characterDto.eyecolorShade2 || '',
        skintoneShade1: characterDto.skintoneShade1 || '',
        skintoneShade2: characterDto.skintoneShade2 || '',
        ...
        currently: characterDto.currently,
        oocInfo: characterDto.oocInfo,
